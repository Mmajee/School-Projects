...
class List:
    ...
    def remove(self, key):
        ...
        if i != -1:
            ...
            if previous is None and current._next is None:
                self._front = None
                self._rear = None
            elif previous is None:
                current = current._next
    ...
    def __setitem__(self, i, value):
        ...
        node = _List_Node(deepcopy(value), current._next)
    ...
    def _reverse_r_aux(self, node):
        ...
        self._reverse_r_aux(node._next)
    ...
    def clean(self):
        ...
        while current is not None:
            ...
            while current2 is not None:
                previous = current2
                if current2._value == value:               
                    previous._next = current2._next
                    current2 = previous
    ...
    def _is_identical_r_aux(self, self_node, other_node):
        ...
        if self_node is None:
            ...
            identical = self._is_identical_r_aux(self_node._next, other_node._next)
    ...
    def split_alt_r(self):
        ...
        if self._front is not None:
            ...
            even, odd = self._split_alt_r_aux(even, odd, left)
        return even, odd
    
    def _split_alt_r_aux(self, even, odd, left):
        ...
        if self._front is None:
            ...
            left = not left
            self._split_alt_r_aux(even, odd, left)
        else:

...
class Sorted_List:
    ...
    def count(self, key):
        ...
        if i != -1:
            ...
            while i != len(self._values) - 1 and self._values[i + 1] == key:
                number += 1
                
            while i != 0  and self._values[i - 1] == key:
                number += 1
    ...
    def remove_many(self, key):
        ...
        if i != -1:
            ...
            while count < length:
                if i < len(self._values) - 1  and self._values[i + 1] == key:
                    self._values.pop(i + 1)
                elif i != 0 and self._values[i - 1] == key:
                    self._values.pop(i - 1)
                count += 1

...
class List:
    ...
    def __getitem__(self, i):
        ...
        count = 0
        count2 = -1
        length1 = len(self._values)
        length2 = (-(len(self._values)) - 1)
        
        
        if i >= 0:
        
            while k == True and count < length1:
                if count == i:
                    value = deepcopy(self._values[count])
                    k = False
                count += 1
        else:
            while k == True and count2 > length2:
                if count2 == i:
                    value = deepcopy(self._values[count2])
                    k = False
                count2 -= 1
    ...
    def _is_valid_index(self, i):
        ...
        return str(i).isdigit() and i >= 0 and i < len(self._values) 
    ...
    def _linear_search(self, key):
        ...
        while k == True and count < len(self._values):
    ...
    def clean(self):
        ...
        while length != 0 and i != length:
            if self._values[i] in self._values[0:i]:
                self._values.pop(i)
                i += 1
                length += 1
    ...
    def combine(self, source1, source2):
        ...
        while i < length:
            ...
            if len(source1) != 0 and len(source1) >= len(source2):
                x = source1.pop(0)
                self._values.append(x)
                
            if len(source2) != 0 and len(source2) > len(source1):
                x = source2.pop(0)
                self._values.append(x)
    ...
    def remove_many(self, key):
        ...
        while key in self._values and i < length:
    ...
    def union(self, source1, source2):
        ...
        while i < length:
            if len(source1) < i and source1[i] not in self._values:
                self._values.append(source1[i])
            
            if len(source2) < i and source2[i] not in self._values:

...
class Priority_Queue:
    ...
    def insert(self, value):
        ...
        while self._values[self._first] != value and count < length and self._first < length:
            
            if self._values[self._first] > self._values[count]:
                self._first = count
            count += 1
    ...
    def _set_first(self):
        ...
        while count < length and self._first < length:
